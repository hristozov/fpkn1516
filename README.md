...
Тук са събрани помощни материали за упражненията по Функционално програмиране за специалност Компютърни науки през учебната 2015/2016. Това хранилище спомага учебните занятия на 5-та и 6-та група на 2-ри поток (при проф. Магдалина Тодорова), но може да бъде използвано от всички студенти, изучаващи Функционало програмиране във ФМИ.

Moodle курсът може да бъде намерен [тук](http://moodle.openfmi.net/enrol/index.php?id=995). Там могат да бъдат намерени по-важните съобщения, свързани с учебната дейност. Хранилището с кода от миналогодишния курс можете да намерите [тук](https://github.com/hristozov/fpkn1415).
...
Ако в тук намерите код, който не работи правилно или създава някакви проблеми, не се страхувайте да [създадете issue](https://github.com/hristozov/fpkn1516/issues) или да ми [пишете мейл](mailto:georgi@forkbomb.nl). Ще съм ви много благодарен!
